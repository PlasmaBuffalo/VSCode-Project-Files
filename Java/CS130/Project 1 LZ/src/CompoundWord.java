...
public class CompoundWord {
    ...
    public void whetherCompound(Word w) {
        ...
        // switch for each case if the word was compound or not and if the user said it
        // was or not
        switch (answer) {
            case "y":
                if (w.isCompound()) {
                    // if word is compound and user said it was, print a message saying they were
                    // correct
            ...
            case "n":
                if (w.isCompound()) {
                    ...
                    // if word was not compound and user said it was not, print a message saying
                    // they were correct
                    System.out.println("Correct!");
                }
                break;
    ...
    public void whereCompound(Word w) {
        ...
        if (answer == w.getIndex()) {
            ...
            // if the answer is incorrect, print a message saying they were incorrect and
