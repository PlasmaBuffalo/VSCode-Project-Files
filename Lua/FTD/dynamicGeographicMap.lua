...
function Update(I)
    ...
    for i = 0, componentCount, 1 do
        ...
        if I:IsPiston(I:GetSubConstructIdentifier(i)) and (I:GetSubConstructInfo(I:GetSubConstructIdentifier(i)).Valid) then
            ...
            -- print out the local position of the piston
            I:Log(
                "localPos of ID=" .. pistonInfo.SubConstructIdentifier .. " is " .. pistonInfo.LocalPosition.x .. ", " ..
                    pistonInfo.LocalPosition.y .. ", " .. pistonInfo.LocalPosition.z)

            -- difference between piston positions: pInfo.LocalPosition - zeroPoint
            local pistonPosDiff = pistonInfo.LocalPosition - zeroPoint
            I:Log("pistonPosDiff is " .. pistonPosDiff.x .. ", " .. pistonPosDiff.y .. ", " .. pistonPosDiff.z)
